...
def forum_read(branch_id=None, root_id=None, leaf_id=None, max_pages=5,
    ...
    for page in range(1, max_pages + 1):
        payload = {
            ...
            "leaf": leaf_id,
            "WholePage": None,
            "LoginRequestedBy": login_requested_by or FORUM_USER,  # brief §5.2 — zastępuje "login"; bez JWT
            "PagingInfo": {
                "CurrentPage": page
            }
        }
        if login_acting_as:
            payload["LoginActingAs"] = login_acting_as
            payload["MemberTypeActingAs"] = member_type_acting_as if member_type_acting_as else (
