...
if "operator" not in st.session_state:
    ...
    op = st.selectbox("Operator:", ["Sylwia", "Emilia", "Oliwia", "Magda", "Ewelina", "Iwona", "Marlena", "EwelinaG", "Andrzej", "Marta", "Klaudia", "kasia_k", "kinga", "Anna_m", "Romana"])
...
OPERATORS_TEL = {
    ...
    "Marta": True, "Klaudia": True, "kasia_k": True, "kinga": True, "Anna_m": True,
