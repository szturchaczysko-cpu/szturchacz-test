        ...
        if not _woreczek:
            ...
            for _wd in _woreczek:
                ...
                if st.button("📞 Pobierz case telefoniczny", key=f"_wor_pull_{_wd.id}", type="primary"):
                    # Ładujemy jako case ODWROTNY (FORUM) — reszta dzieje się normalną ścieżką:
                    # wsad w polu po prawej, forum sprawdzane przy analizie, finisz tagiem.
                ...
                for model_id in models_to_try:
                    ...
                    for attempt in range(5):
                        try:
                            ...
                            # Woreczek dostaje sprawę TYLKO gdy poszedł realny wpis delegujący — bez tego
                            # telefonista nie ma na czym pracować, więc i woreczek nie ma sensu.
                            _had_tel_delegation = ("[FORUM_WRITE|" in ai_text and "telefoniści" in ai_text.lower())
