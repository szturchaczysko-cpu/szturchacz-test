...
def ew_complete_case(case_doc_id, result_tag=None, result_pz=None, prompt_name=None, prompt_url=None, prompt_filename=None, prompt_github_link=None, prompt_layer=None):
    ...
    if not czyste_okno:
        ...
        if show_current_case:
            ...
            if st.button("✅ Zakończ → Następny"):
                ...
                if tag:
                    if case.get("_doc_id"):
                        ew_complete_case(case["_doc_id"], result_tag=tag, result_pz=pz, prompt_name=cfg.get("prompt_name"), prompt_url=cfg.get("prompt_url"), prompt_filename=cfg.get("prompt_filename"), prompt_github_link=cfg.get("prompt_github_link"), prompt_layer=cfg.get("prompt_layer"))
