                        ...
                        if wsad:
                            ...
                            if FORUM_ENABLED and nrzam:
                                ...
                                if forum_ctx:
                                    ...
                                    ew_log_ponaglenia_bota(_nr_diag if '_nr_diag' in dir() else '', operator_grupa)
                                    ...
                                    for _idx_fw, fw in enumerate(forum_result["forum_writes"]):
                                        if fw.get("success"):
                                            ...
                                            if fw.get("FORUM_ID"):
                                                ...
                                                _tresc_w = str(fw.get("tresc") or "") + " " + str(_ud_fw)
                                            ...
                                            _to_koniec_tel = bool(re.search(
                                                ...
                                                (fw.get("tresc") or "") + " " + ai_text, re.IGNORECASE))
                                            ...
                                            if fw.get("FORUM_ID") and _to_prosba_o_tel:
                                                st.session_state["_ost_zlec_po_tel"] = str(fw.get("FORUM_ID"))
                                            ...
                                            _to_rap_tel = bool(re.search(
                                                ...
                                                (fw.get("tresc") or ""), re.IGNORECASE))
                                            if _to_rap_tel and _nrzam_e2 and fw.get("FORUM_ID"):
                                                try:
                                            ...
                                            if (_nrzam_e2 and _ud_fw.lower().startswith("telefoni")
                                                ...
                                                ew_log_deleg(
                                                    ...
                                                    id_postu=fw.get("FORUM_ID"), link=fw.get("link"),
