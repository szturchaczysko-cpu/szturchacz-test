...
with st.sidebar:
    ...
    with st.expander("📞 Woreczek telefoniczny", expanded=False):
        st.caption("Sprawy z delegowanym telefonem (FORUM_TEL=czekam_wynik). Kliknij Pobierz case "
                   "telefoniczny — wsad ląduje po prawej i prowadzisz sprawę jak każdą inną: "
                   "forum, analiza, checklista od AI, finalny tag. Zakończenie tagiem usuwa ją z woreczka.")
        try:
